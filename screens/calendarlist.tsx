...
export default function calendarlist() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonRow}>
        <TouchableOpacity style={[styles.topButton, styles.inactiveButton]} onPress={() => navigation.navigate('createrdv')}>
  ...
  <Table borderStyle={{ borderWidth: 0.5, borderColor: Colors.primary }}>
    <Row
      data={["Sujet", "Date Début", "Date Fin", "Lieu", "Durée", "Action"]}
      style={styles.head}
      ...
      <Row
        ...
        data={[
          ...
          <View style={styles.actionCell}>
            <TouchableOpacity onPress={() => handleDeleteAppointment(rowData.id)} style={styles.iconContainer}>
              <Feather name="trash-2" size={24} color="gray" />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => navigation.navigate('EditRdv', { id: rowData.id })} style={styles.iconContainer}>
