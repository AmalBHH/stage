...
export default function importpres() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonRow}>
        <TouchableOpacity style={[styles.topButton, styles.inactiveButton]} onPress={() => navigation.navigate('importpres')}>
          <Text style={styles.buttonText}>Importer</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.topButton, styles.activeButton]} onPress={() => navigation.navigate('presence')}>
