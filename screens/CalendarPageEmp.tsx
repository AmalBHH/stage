...
export default function CalendarPageEmp() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.topBar}>
          <TouchableOpacity onPress={() => navigation.navigate('CalendarPageEmp')} style={styles.iconButton}>
            <Feather name="calendar" size={30} color="black" />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('calendarlistEmp')} style={styles.iconButton}>
