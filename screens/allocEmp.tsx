    ...
    useEffect(() => {
      const fetchUserConges = async () => {
        try {
          ...
          if (userId) {
            const q = query(collection(db, "allocation"), where("userId", "==", userId)); 
      ...
      <View style={styles.container}>
        ...
        <View style={styles.inlineItems}>
          ...
          <TouchableOpacity style={styles.button}>
            <Text style={styles.buttonText} onPress={() => navigation.navigate('postallocation')}>Nouvelle demande d'allocation</Text>
          </TouchableOpacity>
        </View>        
