...
export default function pivoteevent() {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonRow}>
        <TouchableOpacity style={[styles.topButton, styles.inactiveButton]} onPress={() => navigation.navigate('createevent')}>
          <Text style={styles.buttonText}>Mesures</Text>
        </TouchableOpacity>
      ...
      <View style={styles.secondaryButtons}>
        ...
        <Feather name="grid" size={24} color="black" onPress={() => navigation.navigate('pivoteevent')}/>
      </View>
      ...
      <View style={styles.mainContent}>
        ...
        Pas de données à afficher</Text>
        <Text style={{ textAlign: 'center', fontSize: 14, marginBottom: 20 }}>
        Essayez d'ajouter des enregistrements ou assurez-vous qu'il existe au moins une mesure et aucun filtre actif dans la barre de recherche.
</Text>
      </View>
