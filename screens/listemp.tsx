  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonRow}>
        <TouchableOpacity style={[styles.topButton, styles.inactiveButton]} onPress={() => navigation.navigate('creeemp')}>
      ...
      <View style={styles.secondaryButtons}>
        ...
        <Feather name="list" size={24} color="black" onPress={() => navigation.navigate('listemp')} />
        <Feather name="clock" size={24} color="gray" onPress={() => navigation.navigate('empact')}/>
      </View>
      ...
      <View style={styles.tableContainer}>
        <View style={styles.tableHeader}>
          ...
          <Text style={styles.headerText}>Num Tel</Text>
        </View>
